    ...
    <nav class="flex-1 px-3 py-6 space-y-6 overflow-y-auto">
        ...
        <div>
            ...
            <div class="space-y-1">
                ...
                <a href="{{ route('financial-accounts.index') }}" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition {{ request()->routeIs('financial-accounts.*') ? 'bg-white/10 text-white' : 'text-slate-400 hover:bg-white/5 hover:text-white' }}">
                    Financial Accounts
                </a>
            </div>
        </div>
    ...
    <div class="fixed inset-y-0 left-0 flex max-w-full">
        <div class="w-72 bg-slate-950 text-white flex flex-col h-full shadow-2xl">
            ...
            <nav class="flex-1 px-4 py-6 space-y-4 overflow-y-auto">
                ...
                <a href="{{ route('financial-accounts.index') }}" @click="sidebarOpen = false" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-slate-300 hover:bg-white/10">Financial Accounts</a>
            </nav>
        </div>
    </div>
</div>